...
**C# gap (`D-009`):** C# spawns only the 3 heroes; the ~280 level objects + companions (`0x98`/`0x90`/`0x91`/`0x94`) are not emitted — needs a C# level/markerset loader. Status: open.
