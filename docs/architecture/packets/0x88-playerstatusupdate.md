...
|---|---|---|---|
| C→S | 9 B (1 opcode + 4 status + 4 progress) | [08 PreDungeon](../phases/08-predungeon.md), [11 ChainCashOut](../phases/11-chaincashout.md) | ⚠️ C# reads LE, C++ reads BE |
| S→C | 2 B (1 opcode + 1 playerState) | [08 PreDungeon](../phases/08-predungeon.md) | ❓ C# WriteTo emits 8 bytes wrong shape |
...
- [Phase 08 PreDungeon](../phases/08-predungeon.md) — primary call site: status 2→4→8 sequence drives dungeon load
- [Phase 11 ChainCashOut](../phases/11-chaincashout.md) — status=0x20 BeamOut path
