...
|---|---|---|---|
| S→C | variable (1 + N×72 + 4 B) | [11 ChainCashOut](../phases/11-chaincashout.md) | ⚠️ |
...
- [Phase 11 ChainCashOut](../phases/11-chaincashout.md) — distinguishes this from the cashout blob
