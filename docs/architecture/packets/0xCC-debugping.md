...
2. **Add the `ChainCashOut` arm** to `Game.HandleDebugPing` — see [Phase 11](../phases/11-chaincashout.md) audit item #5.
...
- [Phase 06 Spaceship](../phases/06-spaceship.md) — implicit DebugPing after PartyMergeComplete
- [Phase 07 ChainVoting](../phases/07-chainvote.md) — DebugPing → ChainVoteMsgs(0)
- [Phase 09 Dungeon](../phases/09-dungeon.md) — DebugPing → big setup burst
- [Phase 11 ChainCashOut](../phases/11-chaincashout.md) — DebugPing → ChainCashOutMsgs(1)
