...
|---|---|---|---|
| S→C | 2 B (value=0) / 714 B (value=1) | [11 ChainCashOut](../phases/11-chaincashout.md) | ❌ |
...
|---|---|---|---|---|
| `0x00` | `value` | u8 | — | =1 |
| `0x01..0x2C8` | `CashOutData::WriteTo` 0x2C8 buffer | absolute-offset writes | BE (default) — **unverified** | See [Phase 11](../phases/11-chaincashout.md#cashoutdatawriteto-instancecpp30-52) for full offset table. |
...
- [Phase 11 ChainCashOut](../phases/11-chaincashout.md) — full flow + 0x2C8 layout
