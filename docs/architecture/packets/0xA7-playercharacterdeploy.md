...
|---|---|---|---|
| S→C | 10 B | [09 Dungeon](../phases/09-dungeon.md), [10 Gameloop](../phases/10-gameloop.md) | ⚠️ |
...
3. **Field order audit on C# side.** Earlier note in [Phase 09 docs](../phases/09-dungeon.md) said "5 B" — that's wrong. Reconfirm the C# packet's `WriteTo`.

---

## Related

- [Phase 09 Dungeon](../phases/09-dungeon.md) — initial deploy after `OnPlayerStart`
- [Phase 10 Gameloop](../phases/10-gameloop.md) — runtime swap (missing in C#)
