...
|---|---|---|---|
| S→C | 24 B | [09 Dungeon](../phases/09-dungeon.md), [10 Gameloop](../phases/10-gameloop.md) | ❓ |
...
- [Phase 09 Dungeon](../phases/09-dungeon.md) — init updates
- [Phase 10 Gameloop](../phases/10-gameloop.md) — periodic ticker
