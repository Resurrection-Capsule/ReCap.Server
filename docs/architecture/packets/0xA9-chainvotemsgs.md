...
|---|---|---|---|
| S→C | 2 / 339 / 6 / 3 B (per `value`) | [07 ChainVoting](../phases/07-chainvote.md), [11 ChainCashOut](../phases/11-chaincashout.md) | 🔒 |
...
|---|---|---|---|---|
| `0x00` | `value` | u8 | — | =0 |
| `0x01..0x151` | `ChainData::WriteTo` 0x151 buffer | raw | **LE** 🔒 | Levels, enemies, cinematics, voiceovers, completionFlag. See [Phase 07](../phases/07-chainvote.md#chaindata-buffer-0x151-bytes) for the per-offset breakdown. |
...
- [Phase 07 ChainVoting](../phases/07-chainvote.md) — main flow
- [Phase 11 ChainCashOut](../phases/11-chaincashout.md) — cashout reuse of this opcode
