...
|---|---|---|---|
| C→S | 2 / 3 / 7 B (per `byteCount`) | [07 ChainVoting](../phases/07-chainvote.md), [08 PreDungeon](../phases/08-predungeon.md) | ✅ |
...
- [Phase 07 ChainVoting](../phases/07-chainvote.md) — byteCount=2 flow
- [Phase 08 PreDungeon](../phases/08-predungeon.md) — byteCount=6 flow
