...
|---|---|---|---|
| S→C | 2 B | [12 GameOver](../../flow/phases/12-gameover.md) | ❌ |
...
`ReCap.Cpp/darkspore_server/source/RakNet/Server.cpp:2334-2348`:
...
2. **Wipe-detection trigger.** Neither side detects party wipe. Without that, `state=1` has nowhere to fire from. See [Phase 12](../../flow/phases/12-gameover.md) for the trigger discussion.
...
- [Phase 12 GameOver](../../flow/phases/12-gameover.md) — failure lane
