...
|---|---|---|---|
| S→C | 5 B | [11 ChainCashOut](../../flow/phases/11-chaincashout.md), [13 Disconnect](../../flow/phases/13-disconnect.md) | ❌ C# missing |
...
`ReCap.Cpp/darkspore_server/source/RakNet/Server.cpp:1268-1277`:
...
Sketch for [ROADMAP M4](../../planning/ROADMAP.md) implementation:
...
- [Phase 11 ChainCashOut](../../flow/phases/11-chaincashout.md) — `BeamOut` path
- [Phase 13 Disconnect](../../flow/phases/13-disconnect.md) — potential future use
