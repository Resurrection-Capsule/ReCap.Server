...
|---|---|---|---|
| S→C | variable (typically 50-200 B) | [09 Dungeon](../../flow/phases/09-dungeon.md), [10 Gameloop](../../flow/phases/10-gameloop.md) | ⚠️ |
...
- [Phase 09 Dungeon](../../flow/phases/09-dungeon.md) — marker + hero spawn flow
- [Phase 10 Gameloop](../../flow/phases/10-gameloop.md) — dynamic spawns (loot, enemies)
