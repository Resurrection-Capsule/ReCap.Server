...
|---|---|---|---|
| S→C | 2 B | [05 RakNet Connect](../../flow/phases/05-raknet-connect.md) | ❓ |
...
`ReCap.Cpp/darkspore_server/source/RakNet/Server.cpp:1288-1295`:
...
- [Phase 05 RakNet Connect](../../flow/phases/05-raknet-connect.md) — first-connect flow
