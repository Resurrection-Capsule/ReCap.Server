...
|---|---|---|---|
| C→S | ❓ unknown | [13 Disconnect](../../flow/phases/13-disconnect.md) | ❌ |
...
3. **Reason code distinction.** If the body carries a code, surface it as `session.Disconnected += reason => …` (currently discarded — see [Phase 13](../../flow/phases/13-disconnect.md)).
...
- [Phase 13 Disconnect](../../flow/phases/13-disconnect.md) — overall disconnect flow + leak shape
