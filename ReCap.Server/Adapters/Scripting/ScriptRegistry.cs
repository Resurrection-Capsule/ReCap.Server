...
public sealed record ScriptEntry(string Name, uint Hash, int TableRef, bool HasTick, bool HasActivate, bool HasDeactivate, IReadOnlyList<float>? Cooldowns = null, int ActivationType = 0)
{
