...
public sealed record ScriptEntry(string Name, uint Hash, int TableRef, bool HasTick, bool HasActivate, bool HasDeactivate, IReadOnlyList<float>? Cooldowns = null, int ActivationType = 0, int HandledEvents = 0, bool RequiresAgent = false, int ModifierPriority = 0, bool DeactivateOnInterrupt = false)
{
